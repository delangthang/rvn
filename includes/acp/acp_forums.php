...
$user->add_lang('mods/info_acp_recenttopics');
		$user->add_lang('mods/acp_topic_prefix');
...
'forum_recent_topics'	=> request_var('forum_recent_topics', 1),
						...
						'forum_topic_prefixes'			=> utf8_normalize_nfc(request_var('forum_topic_prefixes', '', true)),
						'forum_topic_prefix_required'	=> request_var('forum_topic_prefix_required', false),
				...
				//End MOD: Limit Post as Count
					...
					if ($forum_data['forum_topic_prefixes'])
					{
...
'RECENT_TOPICS'				=> $forum_data['forum_recent_topics'],
					...
					'FORUM_TOPIC_PREFIXES'		=> str_replace(';', "\n", $forum_data['forum_topic_prefixes']),
					'S_TOPIC_PREFIX_REQUIRED'	=> ($forum_data['forum_topic_prefix_required']) ? true : false,
