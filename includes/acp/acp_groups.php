			...
			case 'add':
				...
				if ($update)
				{
					...
					$submit_ary = array(
						...
						'bypass_post_req'	=> isset($_REQUEST['group_bypass_post_req']) ? 1 : 0,
				...
				$template->assign_vars(array(
					...
					'GROUP_BYPASS_POST_REQ'	=> (isset($group_row['group_bypass_post_req']) && $group_row['group_bypass_post_req']) ? ' checked="checked"' : '',
