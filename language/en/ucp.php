...
$lang = array_merge($lang, array(
	...
	'UCP_ADMIN_ACTIVATE'		=> 'Lưu ý: bạn cần một địa chỉ Email hợp lệ để kích hoạt tài khoản. Nếu gặp khó khăn trong việc kích hoạt tài khoản hãy liên hệ YM: mclv1n4 hoặc email: delangthang@rakionvn.net',
	'UCP_AIM'					=> 'AOL Instant Messenger',
	'UCP_ATTACHMENTS'			=> 'Attachments',
	'UCP_COPPA_BEFORE'			=> 'Before %s',
	'UCP_COPPA_ON_AFTER'		=> 'On or after %s',
	'UCP_EMAIL_ACTIVATE'		=> 'Lưu ý: bạn cần một địa chỉ Email hợp lệ để kích hoạt tài khoản. Nếu gặp khó khăn trong việc kích hoạt tài khoản hãy liên hệ YM: mclv1n4 hoặc email: delangthang@rakionvn.net',
	'UCP_ICQ'					=> 'ICQ number',
