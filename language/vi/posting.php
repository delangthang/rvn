...
$lang = array_merge($lang, array(
	...
	//Begin MOD: Limit Post as Count
	'ERROR_POST_COUNT'			=> 'Bạn chỉ được cho phép tối đa %s lần post trong chuyên mục này',
	'ERROR_TOPIC_COUNT'			=> 'Bạn chỉ được tạo tối đa %s topic trong chuyên mục này',
	'ERROR_POSTS_COUNT'			=> 'Bạn chỉ được cho phép tối đa %s lần post trong chuyên mục này',
	'ERROR_TOPICS_COUNT'		=> 'Bạn chỉ được tạo tối đa %s topic trong chuyên mục này',
	'ERROR_POST_REST'			=> 'Bạn còn <strong class="error">%s</strong> lần post trong chuyên mục này',
	'ERROR_POSTS_REST'			=> 'Bạn còn <strong class="error">%s</strong> lần post trong chuyên mục này',
	'ERROR_TOPIC_REST'			=> 'Bạn còn <strong class="error">%s</strong> topic được phép tạo trong chuyên mục này',
	'ERROR_TOPICS_REST'			=> 'Bạn còn <strong class="error">%s</strong> topic được phép tạo trong chuyên mục này',
	'ERROR_POST_TOPIC_REST'		=> 'Bạn còn <strong class="error">%s</strong> topic và <strong class="error">%s</strong> lần post được phép tạo trong chuyên mục này. (Chú ý: một topic mới được tính là 1 post!)',
	'ERROR_POSTS_TOPIC_REST'	=> 'Bạn còn <strong class="error">%s</strong> topic và <strong class="error">%s</strong> lần post được phép tạo trong chuyên mục này. (Chú ý: một topic mới được tính là 1 post!)',
	'ERROR_POST_TOPICS_REST'	=> 'Bạn còn <strong class="error">%s</strong> topic và <strong class="error">%s</strong> lần post được phép tạo trong chuyên mục này. (Chú ý: một topic mới được tính là 1 post!)',
	'ERROR_POSTS_TOPICS_REST'	=> 'Bạn còn <strong class="error">%s</strong> topic và <strong class="error">%s</strong> lần post được phép tạo trong chuyên mục này. (Chú ý: một topic mới được tính là 1 post!)',
	//End MOD: Limit Post as Count
